...
<!-- Page Heading -->
<h1 class="h3 mb-2 font-weight-bold text-gray-800">Editar usuario</h1>
<p class="mb-4"> </p>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nameUser" name="nombre" placeholder="Nombre" value="{{ $userEdit->nombre }}"/>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="paternalSurnameUser" name="ape_pat" placeholder="Apellido Paterno" value="{{ $userEdit->ape_pat }}"/>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="maternalSurnameUser" name="ape_mat" placeholder="Apellido Materno" value="{{ $userEdit->ape_mat }}"/>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="phoneUser" name="tel" placeholder="Número celular o fijo" data-mask="000 000 0000" value="{{ $userEdit->tel }}">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="cargoUser" name="cargo" placeholder="Cargo" value="{{ $userEdit->cargo }}"/>
