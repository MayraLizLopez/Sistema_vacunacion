    ...
    <body>
        ...
        <div class="card border-secondary mb-3" style="max-width: 18rem; border: 3px solid #2756B1; border-radius: 5px;">
            ...
            <div class="card-body text-secondary">
                ...
                <div class="mb-3">
                    <a style="color: #ffffff; background-color: #54A583; margin-top: 25px; font-size: 20px; border: 2px solid #54A583; border-radius: 5px;" href="http://voluntariado.jalisco.gob.mx/emailAceptar/{{$sede->uuid}}">Aceptar</a>        
                </div>
            </div>
        </div>
        ...
        <div class="mb-3" style="margin-top: 35px;"></div>
        <p></p>
        <a style="color: #ffffff; background-color: gray; margin-top: 25px; font-size: 20px; border: 2px solid #6A7379; border-radius: 5px;" href="http://voluntariado.jalisco.gob.mx/emailRechazar/{{$uuid}}">Rechazar</a>
